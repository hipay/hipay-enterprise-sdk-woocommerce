    ...
    class Gateway_Hipay extends WC_Payment_Gateway
    {
        ...
        public function isAvailableForCurrentCart()
        {
            ...
            if (in_array(
                    ...
                    $plugin_method_settings['woocommerce_hipayenterprise_methods_payments_currencies_list']
                )
                && in_array(
                    $woocommerce->customer->get_billing_country(),
                    $plugin_method_settings['woocommerce_hipayenterprise_methods_payments_countries_list']
                )) {
                if (($max_value != 0 && $total_amount > $max_value) ||
                    ($min_value != 0 && $total_amount < $min_value)) {
