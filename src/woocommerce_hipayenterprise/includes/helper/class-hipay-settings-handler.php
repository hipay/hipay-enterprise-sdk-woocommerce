    ...
    public function savePaymentGlobal(&$settings)
    {
        ...
        try {
            ...
            $configFormData = array(
                ...
                'number_saved_cards_displayed' => sanitize_title(Hipay_Helper::getPostData('number_saved_cards_displayed')),
                'switch_color_input' => Hipay_Helper::getPostData('switch_color_input'),
                'checkbox_color_input' => Hipay_Helper::getPostData('checkbox_color_input'),
