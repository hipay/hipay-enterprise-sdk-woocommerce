<table class="woocommerce-table woocommerce-table-hipay-multibanco">
	<thead>
		<tr>
			<th colspan="3" class="woocommerce-table-hipay-title"><?php _e("Pay the reference at an ATM or with your Homebanking account.")?>
               </th>
		</tr>
	</thead>
	<tbody>
        <tr>
            <th colspan="3" class="woocommerce-table-hipay-field"><img style="max-width: 200px;align-content: center"id="multibanco-hipay" alt="multibanco" src="<?php echo $logo;?>" /></th>
        </tr>
		<tr>
