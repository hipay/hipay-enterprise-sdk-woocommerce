...
<input id="<?php echo $localPaymentName ?>-payment-product" type="hidden" name="method"/>
<input id="<?php echo $localPaymentName ?>-payment-method" type="hidden" name="paymentmethod" />
<input id="<?php echo $localPaymentName ?>-productlist" type="hidden" name="productlist" />
