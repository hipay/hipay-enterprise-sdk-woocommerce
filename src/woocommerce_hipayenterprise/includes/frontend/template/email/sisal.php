<style>
    .sisal-emailTemplate td {
        background-color:inherit !important;
    }
</style>
<div class="sisal-emailTemplate">
        ...
        <tr>
            <td style="padding: 20px;">
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="padding-bottom: 0;margin-bottom: 0">
                    <tr>
                        <td>
                            <img src="<?php echo plugins_url('/assets/images/sisal.png', WC_HIPAYENTERPRISE_BASE_FILE)?>" alt="Sisal" style="display: block; margin: 0 auto; max-width: 150px; width: 100%;">
                        </td>
                    </tr>
                    <tr>
