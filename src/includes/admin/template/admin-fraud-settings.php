    ...
    <td class="forminp">
        <fieldset>
            ...
            <input class="input-text regular-input " type="text"
                   ...
                   value="<?php echo esc_textarea($fraud["woocommerce_hipayenterprise_fraud_copy_to"]); ?>" placeholder="">
    ...
    <td class="forminp">
        <fieldset>
            ...
            <select class="select " name="woocommerce_hipayenterprise_fraud_copy_method"
                ...
                <option
                        value="bcc"<?php if (esc_textarea($fraud["woocommerce_hipayenterprise_fraud_copy_method"]) == "bcc") echo " SELECTED"; ?>><?php _e('Bcc', 'hipayenterprise'); ?></option>
                <option
                        value="separate_email"<?php if (esc_textarea($fraud["woocommerce_hipayenterprise_fraud_copy_method"]) == "separate_email") echo " SELECTED"; ?>><?php _e('Separate email', 'hipayenterprise'); ?></option>
            </select>
